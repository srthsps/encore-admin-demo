...
const Category = () => {
  ...
  return (
    <>
      ...
      <EditCategory toggle={editCategory} setToggle={setEditCategory} id={catId} catData={catData} setCatData={setCatData} />
            ...
            >
              <Card style={{ width: '18rem' }} className="shadow-sm">
                <Card.Body>
                  ...
                  <button onClick={() => handleEdit(item.id,item)} className='  ms-5 btn btn-warning' style={{paddingLeft:"8px", paddingRight:"8px", paddingTop:"2px", paddingBottom:"2px"}} >
