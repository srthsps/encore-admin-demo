...
const OrderList = () => {
  ...
  const {
    orderShippedSuccess,
    orderShippedFetching,
    orderShippedErrorMessage,
    orderShippedError,
  } = useSelector((state) => state.orderShippedSlice)
  const {
    orderCancelledSuccess,
    orderCancelledError,
    orderCancelledFetching,
    orderCancelledErrorMessage,
  } = useSelector((state) => state.orderCancelledSlice)
  const {
    orderDeliveredSuccess,
    orderDeliveredErrorMessage,
    orderDeliveredError,
    orderDeliveredFetching,
  } = useSelector((state) => state.orderDeliveredSlice)
  const {
    orderProcessSuccess,
    orderProcessFetching,
    orderProcessErrorMessage,
    orderProcessError,
  } = useSelector((state) => state.orderProcessSlice)
  ...
  return (
    <>
      <OrderDetails
        toggle={OrderDetailToggle}
        setToggle={setOrderDetailsToggle}
        orderID={orderId}
      />
      <div>
        <Row className="mt-5">
